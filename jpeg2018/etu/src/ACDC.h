...
void LRE(int16_t *entree, struct bitstream *bitstream_jpeg, struct jpeg_desc *jpeg, int couleur, int verbose);

int calcul_DC(int16_t *flux, int premier,int32_t *DC, int couleur, int verbose);
